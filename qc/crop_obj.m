...
parentpath='D:\3Dface\QCForEachPerson\DSY\';  %path最后都记得有斜杠，以单引号包围
...
%    objs(i).delete = 0;
%end
%save([parentpath 'allobjs.mat'],'objs')
%% 
...
for j=ind:length(objs)   
    ...
    while breakValue == 0
       ...
       %% Figure 参数
        ...
        figPosition = [100 100, 900,700 ]; % 示例宽度800像素，高度600像素
